...
These scripts are part of the automation framework. Some are launched by the main GUI, while others may need to be run as separate, persistent processes.

-   `automation/cycle_watcher.py`
-   `automation/scheduler_manager.py`
-   `automation/scheduler_watcher.py`
-   `automation/task_goal_watcher.py`
-   `heartbeat_watcher.py` (Note: This is a standalone script that should be run as a separate process)
