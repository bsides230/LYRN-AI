...
class StreamHandler:
    ...
    def __init__(self, gui_queue, metrics: EnhancedPerformanceMetrics, role_config: dict):
        ...
        self.known_roles = list((self.role_config.get("role_map") or {}).keys())
...
"""
    ...
    def refresh_chat_display(self):
        ...
        for match in tag_regex.finditer(full_log_content):
            ...
            role_map = (self.role_config or {}).get("role_map") or {}
            group_styles = (self.role_config or {}).get("group_styles") or {}
